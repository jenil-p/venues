...
const page = () => {
    ...
    return (
        <>
            <Navbar />
            <div className="message_part relative p-20 pt-36 w-full flex flex-col justify-center items-center h-screen min-h-screen ">
                <div className="main w-full h-full rounded-2xl ">
                    <div className="text-[#484848] text-4xl font-bold flex flex-col gap-1.5">
                        <p className='font-inter '>Add Amenities Available at your place</p>
                    </div>
                ...
                <div className="main w-full h-full rounded-2xl ">
                    <div className="text-[#484848] text-4xl font-bold flex flex-col gap-1.5">
                        <p className='font-inter '>Add Sefty and Hygiene Available at your place</p>
                    </div>
