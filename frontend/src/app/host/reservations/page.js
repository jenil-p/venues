                ...
                <div className="main w-full h-full rounded-2xl ">
                    ...
                    <div className='w-full h-full flex flex-col'>
                        <div className="card w-full py-5 flex justify-between items-center border-b border-[#9A9A9A]">
                            ...
                            <div>
                                <button className='py-2 px-4 text-[#9A9A9A] border mr-2 border-[#9A9A9A] bg-white font-inter rounded-full text-sm'>Reject</button>
                                <button className='py-2 px-4 bg-[#9A9A9A] text-white font-inter rounded-full text-sm'>Accept</button>
                            </div>
                        </div>
                    </div>
                </div>
